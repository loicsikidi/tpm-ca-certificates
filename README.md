...
> [!IMPORTANT]
> The configuration file (mostly) points to public resources (URLs). This ensures that the certificates used in the bundle are accessible to everyone and can be independently verified.
