...
> [!CAUTION]
> [README.md](README.md) supersedes this document. I've kept this document for historical reference.
...
- **Screenshot Reference**: ![infineon_website.png](./archived/infineon_website.png)
...
1. While browsing Infineon's TPM product list ([here](https://www.infineon.com/products/security-smart-card-solutions/optiga-embedded-security-solutions/optiga-tpm)), I noticed references to intermediate certificates signed by an RSA root certificate.
   * ![infineon_tpm_products.png](./archived/infineon_tpm_products.png)
2. Screenshot from the TPM 2.0 product page:
   * ![infineon_slb-9670VQ2.0.png](./archived/infineon_slb-9670VQ2.0.png)
...
**Discovery Method**:
1. While exploring the documentation, I found the [OPTIGA™ Trust M configurations](./archived/infineon-optiga-trust-m-configguide-productfamilyoverview-en.pdf) document which mentions the existence of **Infineon OPTIGA™ ECC Root CA 2** on page 5.
  ![](./archived/infineon_optiga_trust_configuration.png)
...
- **Screenshot Reference**: ![](./archived/infineon_article_ek_intermediate.png)
